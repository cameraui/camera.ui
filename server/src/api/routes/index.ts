...
import { FloorPlanRoute } from './floorplan.routes.js';
...
export class FastifyRoutes {
  ...
  public async register(): Promise<void> {
    ...
    await this.app.register(FloorPlanRoute, { prefix: '/api/floorplan' });
    await this.app.register(RoomsRoute, { prefix: '/api/rooms' });
