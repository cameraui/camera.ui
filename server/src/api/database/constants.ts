...
export const FLOORPLAN_ID = 'floorplan';
...
export const TRAINING_CANDIDATES_ID = 'training-candidates';
export const AUTOMATION_STATE_ID = 'automation-state';
export const ASSISTANT_ID = 'assistant';
export const ASSISTANT_THREADS_ID = 'assistant-threads';
export const ASSISTANT_THREAD_MESSAGES_ID = 'assistant-thread-messages';
export const ASSISTANT_THREAD_ATTACHMENTS_ID = 'assistant-thread-attachments';
export const ASSISTANT_SCHEDULES_ID = 'assistant-schedules';
export const ASSISTANT_PROFILES_ID = 'assistant-profiles';
export const ASSISTANT_USAGE_ID = 'assistant-usage';
export const ASSISTANT_MEMORY_ID = 'assistant-memory';
export const ASSISTANT_STATE_ID = 'assistant-state';
