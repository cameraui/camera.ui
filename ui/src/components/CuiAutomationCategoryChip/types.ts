...
export type AutomationCategory = 'notification' | 'recording' | 'presence' | 'detection' | 'schedule' | 'webhook' | 'mqtt' | 'scene' | 'utility' | 'other';
...
export const AUTOMATION_CATEGORY_META: Record<AutomationCategory, AutomationCategoryMeta> = {
  ...
  mqtt: { icon: MqttIcon, labelKey: 'components.automation_store.category_mqtt' },
...
export const AUTOMATION_CATEGORY_ORDER: AutomationCategory[] = [
  'notification',
  'recording',
  'presence',
  'detection',
