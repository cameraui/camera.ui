...
var contract = {
  ...
  provides: [SensorType.Object, SensorType.Face, SensorType.LicensePlate, SensorType.Clip],
  consumes: [],
  pythonVersion: "3.11",
  interfaces: [PluginInterface.ObjectDetection, PluginInterface.FaceDetection, PluginInterface.LicensePlateDetection, PluginInterface.ClipDetection]
};
